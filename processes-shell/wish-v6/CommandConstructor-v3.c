/* CommandConstructor-v3.c
 * @notes: 1. contains 3 function to construct command
 *         2. do some changes in parseLine() for command
 *             with no spaces inside
 *         3. add an array to remember pid of child, wait
 *             child before execute 'exit'
